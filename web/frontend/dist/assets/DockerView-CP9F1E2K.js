import{$n as e,An as t,Bn as n,Bt as r,Cn as i,Dn as a,Fn as o,Gt as s,Hn as c,Ht as l,In as u,It as d,Ln as f,Mn as p,N as m,Nn as h,Nt as g,Pn as _,Pt as v,Qn as y,Rn as b,Tt as x,U as S,Un as C,V as w,Vn as T,Xn as E,Yn as ee,Zt as D,_ as O,_r as k,_t as A,ar as j,br as M,c as N,cn as P,d as F,dn as I,dr as L,er as te,fn as R,gn as ne,h as z,hn as re,i as ie,in as B,ir as V,jn as H,ln as U,m as ae,mn as W,mr as G,mt as K,nn as oe,nr as se,o as q,or as J,pn as ce,sr as le,vr as Y,wn as ue,wt as de,xn as fe,xt as pe}from"./auth-D4o3KH1m.js";import{T as me,_ as he,f as ge,l as _e,t as ve,v as ye,w as be}from"./AppShell-DZ_BaHG0.js";import{i as xe,r as Se,t as Ce}from"./DataTable-9lp-ucSs.js";import{u as we}from"./useTheme-hnNjk9mo.js";import{t as Te}from"./Modal-BKundZoC.js";import{c as Ee,n as X}from"./LocaleSwitcher-TO6RWRwt.js";import{n as De,t as Oe}from"./render-Br790zyF.js";import{t as ke}from"./get-slot-6kXJmSMP.js";import{t as Ae}from"./Input-CfBagqN8.js";import{t as je}from"./Add-CT40bK1N.js";import{t as Me}from"./Tag-BYeonRWt.js";import{t as Ne}from"./Checkbox-Cf7k2shR.js";import{n as Pe,r as Fe}from"./light-BHr4LYV0.js";import{t as Ie}from"./use-message-D90azGRh.js";import{n as Le,t as Re}from"./DrawerContent-OBnUJaUg.js";import{t as ze}from"./Space-DezJtkk7.js";import{t as Be}from"./Popconfirm-DQPpVgYE.js";import{n as Ve,r as He,t as Z}from"./copy-DWv6xhYH.js";import{t as Ue}from"./trash-2-Brknd4eA.js";import{i as We,n as Ge,t as Q}from"./docker-PJ7w_ctr.js";import{n as Ke,t as $}from"./format-BxLcbkc3.js";import{r as qe,t as Je}from"./inputProps-CMYLxNIO.js";var Ye=he(`.v-x-scroll`,{overflow:`auto`,scrollbarWidth:`none`},[he(`&::-webkit-scrollbar`,{width:0,height:0})]),Xe=b({name:`XScroll`,props:{disabled:Boolean,onScroll:Function},setup(){let e=L(null);function t(e){!(e.currentTarget.offsetWidth<e.currentTarget.scrollWidth)||e.deltaY===0||(e.currentTarget.scrollLeft+=e.deltaY+e.deltaX,e.preventDefault())}let n=l();return Ye.mount({id:`vueuc/x-scroll`,head:!0,anchorMetaName:ye,ssr:n}),Object.assign({selfRef:e,handleWheel:t},{scrollTo(...t){var n;(n=e.value)==null||n.scrollTo(...t)}})},render(){return n(`div`,{ref:`selfRef`,onScroll:this.onScroll,onWheel:this.disabled?void 0:this.handleWheel,class:`v-x-scroll`},this.$slots)}});function Ze(e,t=`default`,n=[]){let{children:r}=e;if(typeof r==`object`&&r&&!Array.isArray(r)){let e=r[t];if(typeof e==`function`)return e()}return n}var Qe=/\s/;function $e(e){for(var t=e.length;t--&&Qe.test(e.charAt(t)););return t}var et=/^\s+/;function tt(e){return e&&e.slice(0,$e(e)+1).replace(et,``)}var nt=NaN,rt=/^[-+]0x[0-9a-f]+$/i,it=/^0b[01]+$/i,at=/^0o[0-7]+$/i,ot=parseInt;function st(e){if(typeof e==`number`)return e;if(A(e))return nt;if(K(e)){var t=typeof e.valueOf==`function`?e.valueOf():e;e=K(t)?t+``:t}if(typeof e!=`string`)return e===0?e:+e;e=tt(e);var n=it.test(e);return n||at.test(e)?ot(e.slice(2),n?2:8):rt.test(e)?nt:+e}var ct=function(){return pe.Date.now()},lt=`Expected a function`,ut=Math.max,dt=Math.min;function ft(e,t,n){var r,i,a,o,s,c,l=0,u=!1,d=!1,f=!0;if(typeof e!=`function`)throw TypeError(lt);t=st(t)||0,K(n)&&(u=!!n.leading,d=`maxWait`in n,a=d?ut(st(n.maxWait)||0,t):a,f=`trailing`in n?!!n.trailing:f);function p(t){var n=r,a=i;return r=i=void 0,l=t,o=e.apply(a,n),o}function m(e){return l=e,s=setTimeout(_,t),u?p(e):o}function h(e){var n=e-c,r=e-l,i=t-n;return d?dt(i,a-r):i}function g(e){var n=e-c,r=e-l;return c===void 0||n>=t||n<0||d&&r>=a}function _(){var e=ct();if(g(e))return v(e);s=setTimeout(_,h(e))}function v(e){return s=void 0,f&&r?p(e):(r=i=void 0,o)}function y(){s!==void 0&&clearTimeout(s),l=0,r=c=i=s=void 0}function b(){return s===void 0?o:v(ct())}function x(){var e=ct(),n=g(e);if(r=arguments,i=this,c=e,n){if(s===void 0)return m(c);if(d)return clearTimeout(s),s=setTimeout(_,t),p(c)}return s===void 0&&(s=setTimeout(_,t)),o}return x.cancel=y,x.flush=b,x}var pt=`Expected a function`;function mt(e,t,n){var r=!0,i=!0;if(typeof e!=`function`)throw TypeError(pt);return K(n)&&(r=`leading`in n?!!n.leading:r,i=`trailing`in n?!!n.trailing:i),ft(e,t,{leading:r,maxWait:t,trailing:i})}var ht=P([U(`descriptions`,{fontSize:`var(--n-font-size)`},[U(`descriptions-separator`,`
